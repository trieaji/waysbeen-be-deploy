...
import (
	...
	transactiondto "golangfnl/dto/transaction"
	"golangfnl/models"
...
func (h *handlerTransaction) UpdateTransaction(w http.ResponseWriter, r *http.Request) {
	...
	// dataTransactions, err := h.TransactionRepository.FindbyIDTransaction(idTrans, "active")
	// if err != nil {
	// 	w.WriteHeader(http.StatusInternalServerError)
	...
	req := &snap.Request{
		...
		CustomerDetail: &midtrans.CustomerDetails{
			FName: dataTransactions.User.Name,  //Buyer
